...
public class Event {
    ...
    public Event(Integer id, String name, String description, Date date, Time time, List<Reservation> reservations, int restaurant, String image, int maxReservations, float price, int nbReservation, boolean estAnnule) {
        this.id = id;
        this.name = name;
