...
//    Document doc = new Document() {};
    ...
    public ObservableList buildData(){
        ...
        try {
        String requete3="select count(type) , type  from Pack group by type";
     ...
     double total = 0;
        ...
        stage.setTitle("Statistiques des packs");
        stage.setWidth(600);
        stage.setHeight(600);
        ...
        chart.setTitle("Statistiques des packs");
    ...
    private void retour(ActionEvent event) throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/gui/CrudPackFXML.fxml"));
