...
//    Document doc = new Document() {};
    ...
    public ObservableList buildData(){
        ...
        try {
        String requete3="select count(datefin) , datefin  from Promotion group by datefin";
     ...
     double total = 0;
        ...
        stage.setTitle("Statistiques des promotions");
        stage.setWidth(600);
        stage.setHeight(600);
        ...
        chart.setTitle("Statistiques des promotions");
    ...
    private void retour(ActionEvent event) throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/gui/CrudPromotionFXML.fxml"));
